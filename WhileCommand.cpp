...
/****************************************************
 * Function Name:       constructor of while command.
 * The Input:           command map, var collection.
 * The Output:
 * Function Operation:  constructs a while command.
 ****************************************************/
WhileCommand::WhileCommand(VarCollection* vc) {
 ...
 ****************************************************/
bool WhileCommand::isConditionTrue(vector<string> condition) {
    vector<string> newv = {};
 ...
 ****************************************************/
void WhileCommand::execute(vector<string> linesVector) {
    ...
    // while the condition is true, iterate the relevant lines.
    while (isConditionTrue(conditionVector)) {
 ...
 * The Output:          null
 * Function Operation:  The function sets a map as member of while command.
 ****************************************************/
void WhileCommand::setCommandMap(map<string, Command *> cm) {
    this->cmdMap = cm;
}